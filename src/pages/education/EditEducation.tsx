...
import { EducationFormData, Education } from '../../types';
...
const EditEducation = () => {
  ...
  useEffect(() => {
    const fetchEducation = async () => {
      ...
      try {
        const response = await educationAPI.getById(parseInt(id));
  ...
  const onSubmit = async (data: EducationFormData) => {
    ...
    try {
      ...
      await educationAPI.update(parseInt(id), data);
  ...
  return (
    <div>
      <PageHeader 
        ...
        description="Perbarui riwayat pendidikan Anda"
        action={
          <button
